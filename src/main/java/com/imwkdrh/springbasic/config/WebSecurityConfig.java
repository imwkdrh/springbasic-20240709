package com.imwkdrh.springbasic.config;
...
import org.springframework.config.http.sessionCreationPolicy;
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        security
                ...
                .authorizeHttpRequests(request -> request
                        // requestMatchers(): URL 패턴, HTTP 메서드 + URL 패턴, HTTP 메소드 마다 접근 허용 방식을 지정하는 메서드

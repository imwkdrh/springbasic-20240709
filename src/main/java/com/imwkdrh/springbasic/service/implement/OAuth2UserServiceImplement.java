...
import com.imwkdrh.springbasic.service.object.CustomOAuth2User;
...
public class OAuth2UserServiceImplement extends DefaultOAuth2UserService {
    ...
    // OAuth2 인증정보를 받고 실행할 비즈니스 로직 메서드
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // 데이터베이스 작업이 들어감
        return new CustomOAuth2User(oAuth2User.getName(), oAuth2User.getAttribute(registration));
    }
}
